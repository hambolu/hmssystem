    ...
    <div class="cotainer">
        <div class="row justify-content-center">
            <div class="col-md-8">
                    <div class="card">
                        <div class="card-body">
                            <form name="my-form"  method="post" action="/admin_patient_show/create">
                                @csrf
...
<table class="table table-bordered table-hover">
  ...
  @foreach($pat_data as $data)
    ...
    <td>{{$data->id}}</td>
      ...
      <td>
        <a href="/admin_patient_show/{{ $data->id }}/edit">edit</a>
      </td>
    <td>
    <form action="admin_patient_show/{{ $data->id }}" method="post">
        @csrf
        @method('DELETE')
